...
<b>Внимание: если в ходе сдачи или выполнения работы вы выяснили что в какой-то из работ, описанной в репозитории нашлась ошибка, убедительная просьба сообщить об этом через Issues с указанием работы.</b>
...
#### 10 семестр
* Контрольная работа
### Физико-химические свойства наноразмерных объектов
*Данный курс лабораторных работ является базовым и проводится только у студентов, обучающихся на кафедре нанометрологии и наноматериалов.*
#### 10 семестр
